---
title: "要件定義書"
description: "機能要件（7プリセット・アドバンスドモード・D&D）と非機能要件"
category: "design"
created: "2026-02-14"
updated: "2026-03-11"
---
...
### 2.9 コンパクトモード（PWA）
- PWAスタンドアロンモード時のみ利用可能
- ヘッダーのトグルボタンでON/OFF切替
- ウィンドウを1:3アスペクト比（縦長）にリサイズ
- UI圧縮: サブタイトル非表示、プリセット説明文非表示、余白圧縮
- 解除時に元のウィンドウサイズに復元
- 詳細: `docs/design/compact-mode-design.md`
...
| UIコンポーネント | 独自実装（CVA + Svelte 5 Runes） |
| 国際化 | sveltekit-i18n |
| テスト | Vitest |
| デプロイ | Vercel |
...
- **Chrome拡張リサイザー**: `chrome.windows.update()` による確実なウィンドウリサイズ → `docs/design/chrome-extension-design.md`
